    ...
    <aside id="left-panel" class="left-panel" ng-controller="tabsCtrl as t">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-plus"></i><a href="#!/addconta">Adicionar Conta</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-plus"></i><a href="#!/addcartao">Adicionar Cartão</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
